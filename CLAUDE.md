...
**Phase 2 closed 2026-05-14; Phase 3 closed 2026-05-15; Phase 4 closed 2026-05-15; Phase 5 closed 2026-05-16; Phase 6 closed 2026-05-17; Phase 7 closed 2026-05-18; Stage 7.6 polish closed 2026-05-18; Phase 8 kicked off 2026-05-18; Stage 8.0 closed 2026-05-18; Stage 8.1 closed 2026-05-18.** Closing summaries at `docs/planning/phase-{2,3,4,5,6,7}-summary.md`. Running project real-money cost: **$0.085018** ($0.08 through Phase 4 + $0.005018 across Phase 6's three cloud-LLM smoke calls; Phase 7 + Stage 7.6 added $0.00). Fourteen operator entry points (Stage 7.6 added `python -m wobblebot.cli.recalibrate`; the numbered list below covers the trading + operator + treasury + dashboard + calibration surfaces; per the Phase 6 close prose `tools/run_cloud_check.py` is the twelfth entry point counted but lives under `tools/` rather than `cli/`):
