...
- **Current:** read the latest dated entry in `docs/planning/roadmap.md`; do not infer
  ...
  Three releases exist — `v1.0.0` (2026-07-31), `v2.0.0` (2026-08-28), and `v2.0.1`
  (2026-09-03) — all tagged with published GitHub Releases. **The `v1.1` name is historical only: that branch's work
