# WobbleBot – Implementation Documentation

This folder contains developer‑facing, hands‑on documentation for building, running, and operating WobbleBot.  Each file serves as the single source of truth for one implementation aspect.

| File | Purpose |
| --- | --- |
| `coding-guidelines.md` | Code style, patterns, and conventions for Python and the project structure. |
| `development-workflow.md` | Local development setup, testing, formatting, and pre-commit workflows. |
| `module-specs.md` | Structure and expectations for per‑module design specifications. |
