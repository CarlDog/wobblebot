...
>
> **Authoritative instead:** `docker/docker-compose.yml`, `CLAUDE.md`'s deploy
> section (the NAS stack is file-based and deliberately detached from git — a
> push to `main` deploys nothing), and [docs/deploy/](../deploy/) for the
> reverse-proxy and encryption-at-rest guides.
