...
>
> **Authoritative instead:** `python -m wobblebot.cli.maintenance --help` for
> the real scheduled-task set, `docker/docker-compose.yml` for how the eight
> daemons actually run, and [docs/planning/roadmap.md](../planning/roadmap.md)
> for current state.
