...
| G6 | Writable POLICY tier and capital-allocation policy. | Configuration/strategy owner; ADR-040 Stage 2 waits for the second qualifying manual POLICY edit and a refreshed fixture. | Accepted policy boundaries, validation, audit and operator-controlled settings. Existing capital reports are not automatic envelope growth. |
