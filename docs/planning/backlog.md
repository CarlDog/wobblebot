...
| PR138 / PR142 | [Original Pylint bump #138](https://github.com/CarlDog/wobblebot/pull/138) closed unmerged; [replacement #142](https://github.com/CarlDog/wobblebot/pull/142) open, verified 2026-09-08. Prior-head checks do not qualify the replacement. | Tooling owner; recheck replacement head and obtain its own merge instruction outside 2.0.10. | Retain historical audit evidence; refresh exact-head and combined compatibility before adoption. |
...
| PR140 | Park [isort major](https://github.com/CarlDog/wobblebot/pull/140). Current CI cannot resolve with pylint 4.0.7; pylint 4.0.8 permits it. Windows default-encoding checks also warn while returning success. | Tooling owner; replacement PR142 first, then explicitly adopt UTF-8 verification and obtain clean Windows/Linux checks. | Isolated isort 9 check passes with UTF-8 and warnings-as-errors; default mode is not accepted. No bulk reformat or environment switch in this patch. |
| C5 | Publication and NAS deployment receipts recorded in the roadmap; formal close remains gated. | Operator + release integrator; finish the authorized final patch and observation campaign, then record acceptance of the remaining limitations. | Verified source/tag/image, preserved stack, current verified backups, rollback rehearsal and bounded behavior receipt; explicit phase close remains outstanding. |
