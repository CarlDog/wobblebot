...
2. **Safety by design**  
   ...
   - Withdrawals and deposits always gated.
...
- **Bot Core** – deterministic trading logic  
- **Kraken Adapter** – all exchange communication  
- **Data Collector** – market data, volatility metrics  
- **Strategy Advisor (LLM)** – suggestion generation  
- **Harvester Module** – fund inflow/outflow management  
- **Orchestrator** – central command & coordination  
- **Storage** – SQLite database + structured logs  
- **Dashboard/Observability** – Grafana or custom UI